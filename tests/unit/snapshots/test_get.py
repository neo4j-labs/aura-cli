...
from aura.snapshots import get_snapshot
...
def test_list_snapshots(api_request, mock_config):
    ...
    result = runner.invoke(
        get_snapshot, ["--instance-id", "123", "--snapshot-id", "789789"], obj=mock_config
    )
    ...
    api_request.assert_called_once_with(
        "GET",
        "https://api.neo4j.io/v1/instances/123/snapshots/789789",
        headers={
...
def test_list_snapshots_with_name(api_request, mock_config):
    ...
    result = runner.invoke(
        get_snapshot, ["--instance-name", "Instance01", "--snapshot-id", "789789"], obj=mock_config
    )
